    ...
    const onScroll = () => {
      ...
      if (nearBottom)
        setVisibleCount((count) =>
          Math.min(count + 3, filteredProducts.length),
        );
    };
    ...
    <MotionSection className="space-y-8">
      <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-soft md:p-5 dark:border-slate-800 dark:bg-slate-900">
        <div className="grid gap-4 lg:grid-cols-[1fr_auto_auto]">
          ...
          <select
            className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-bold dark:border-slate-700 dark:bg-slate-950"
